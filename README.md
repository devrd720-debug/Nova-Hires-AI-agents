...
**Prerequisites:** [Firebase CLI](https://firebase.google.com/docs/cli) (`npm install -g firebase-tools`) and access to the `gen-lang-client-0262075387` Firebase project.
